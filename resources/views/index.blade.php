			...
			<div class="container">
				<div class="hero__content">
					<div class="hero__content__inner" id='navConverter'>
						<h1 class="hero__title">An Employee Management System</h1>
						<p class="hero__text">
							This is a portfolio web application built by Akoh Samuel with Laravel, you can create a workspace for your organization for
							potential employees to sign up to. It contains all CRUD operations with many more features to be implemented with time.
						</p>
						<a href="{{ route('admins.create') }}" class="button button__accent">Open a workspace</a>
						<a href="{{ route('home.create') }}" class="button hero__button">Sign up as user to a workspace</a>
					</div>
				</div>
			</div>
		</div>
